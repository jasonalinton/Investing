/*
  ...
  - You are about to alter the column `amount_Traded` on the `Trade` table. The data in that column could be lost. The data in that column will be cast from `Int` to `Float`.
