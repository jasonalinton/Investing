...
INSERT INTO "new_AssetValue" ("id", "idBaseAsset", "idQuoteAsset", "interval", "symbol", "openTime", "open", "high", "low", "close", "volume", "closeTime", "quoteAssetVolume", "numberOfTrades", "takerBuyBaseAssetVolume", "takerBuyQuoreAssetVolume", "createdAt", "updatedAt") SELECT "id", "idBaseAsset", "idQuoteAsset", "interval", "symbol", "openTime", "open", "high", "low", "close", "volume", "closeTime", "quoteAssetVolume", "numberOfTrades", "takerBuyBaseAssetVolume", "takerBuyQuoreAssetVolume", "createdAt", "updatedAt" FROM "AssetValue";
